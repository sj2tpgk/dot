(define generic-on-key '("zenkaku-hankaku" "<IgnoreCase><Control>j"))
(define generic-on-key? (make-key-predicate '("zenkaku-hankaku" "<IgnoreCase><Control>j")))
(define generic-off-key '("zenkaku-hankaku" "<IgnoreCase><Control>j"))
(define generic-off-key? (make-key-predicate '("zenkaku-hankaku" "<IgnoreCase><Control>j")))
...
(define generic-next-page-key '("next" "insert"))
(define generic-next-page-key? (make-key-predicate '("next" "insert")))
