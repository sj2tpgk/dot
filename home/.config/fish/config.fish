...
set -g fish_color_operator       'blue'        # (~       in ~/xxx/yyy)
set -g fish_color_param          'blue'        # (xxx/yyy in ~/xxx/yyy)
...
set -g fish_color_valid_path     '--underline' # (underline if file exist (color is set in _operator and _param)
